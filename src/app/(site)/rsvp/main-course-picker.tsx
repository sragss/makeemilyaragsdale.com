...
export function MainCoursePicker({
  ...
  return (
    <div className="space-y-3">
      <p className="font-edict text-[10px] font-medium uppercase tracking-[0.36em] text-garden-cream">
        ...
        {allOptions.map((option) => {
          ...
          return (
            <button
              ...
              className={`relative min-h-10 border px-3 py-2 font-edict text-[11px] uppercase tracking-[0.2em] transition-colors ${
                selected

...
export function HomeCard() {
  ...
  return (
    <div className="relative flex h-[min(90svh,calc((100vw-3rem)*1.533333))] w-[calc(100vw-3rem)] items-center justify-center sm:h-auto sm:w-full sm:max-w-[920px]">
      <div className="relative w-[min(90svh,calc((100vw-3rem)*1.533333))] rotate-90 sm:w-full sm:rotate-0">
        <motion.div
          ref={ref}
